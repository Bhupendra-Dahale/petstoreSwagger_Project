...
public class UserTestsPropeties {
	...
	public void createUserTest() {
		...
		Response response = UserEndPointsProperties.createUserRequest(userPayload);
	...
	public void getUserTest() {
		...
		Response response = UserEndPointsProperties.getUserRequest(userPayload.getUsername());
		response.then().log().all();
	...
	public void updateUserTest() {
		...
		Response response = UserEndPointsProperties.updateUserRequest(userPayload.getUsername(), userPayload);
		response.then().log().all();
		Assert.assertEquals(response.statusCode(), 200);
	...
	public void deleteUserTest() {
		...
		Response response = UserEndPointsProperties.deleteUserRequest(userPayload.getUsername());
		response.then().log().all();
		Assert.assertEquals(response.statusCode(), 200);
	}
}
